...
export const constantRouterMap = [
    ...
    },
    {
        ...
        icon: 'morder',
        noDropdown: true,
        children: [{ path: 'index', component: OrderIndex, name: '工单' }]
    }
]
...
export const asyncRouterMap = [{
    ...
    },
    {
        ...
        icon: 'zujian',
        children: [
            { path: 'index', component: componentsIndex, name: '备件库存 ' },
            { path: 'tinymce', component: Tinymce, name: '仓库库存' },
            { path: 'markdown', component: Markdown, name: '仓库出入库单' },
            { path: 'jsoneditor', component: JsonEditor, name: '服务商库存' },
    ...
    },
    {
        ...
        children: [{
            ...
            { path: 'tab/serach', component: Search, name: 'serach' }
        ]
    },
